    ...
    <section id='home' className={`flex md:flex-row flex-col ${styles.padding}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between  item-center w-full'>
          <h1 className='flex-1 font-poppins font-semibold ss:text-[70px] text-[55px] ss:leading-[100px] leading-[75px] text-white'>
        ...
        <h1 className='font-poppins font-semibold ss:text-[65px] text-[52px] ss:leading-[100px] leading-[75px] text-white w-full'>Payment Method.</h1>
